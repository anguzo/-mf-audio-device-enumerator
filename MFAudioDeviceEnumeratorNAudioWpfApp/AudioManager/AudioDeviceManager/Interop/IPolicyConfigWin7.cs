...
namespace MFAudioDeviceEnumeratorNAudioWpfApp.AudioManager.AudioDeviceManager.Interop
{
    ...
    public interface IPolicyConfigWin7
    {
        ...
        void GetPropertyValue([MarshalAs(UnmanagedType.LPWStr)] string wszDeviceId, ref PropertyKey pkey,
            ref PropVariant pv);

        void SetPropertyValue([MarshalAs(UnmanagedType.LPWStr)] string wszDeviceId, ref PropertyKey pkey,
            ref PropVariant pv);
